...
ActiveRecord::Base.transaction do
  ...
  bulgari = Supplier.create(name: "Bulgari‎", address: "台中市中區公園路43號", phone: "042-2833-3121")
  ...
  Product.create(title: "No. 9", image: "http://lcdn.perfume-empire.com/80BD9A/perfume-empire/media/catalog/product/b/v/bvlgari_soir_pur_homme.jpg", price: "5499", content: "bv perfume", qoh: 0, supplier: bulgari, safety: 3, status: 1)
  Product.create(title: "No. 10", image: "http://www.perfume.com/images/products/parent/medium/62472W.jpg", price: "7822", content: "bv perfume 2", qoh: 10, supplier: bulgari, safety: 10, status: 1)
