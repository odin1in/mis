...
class Admin::UsersControllerTest < ActionController::TestCase
  ...
  test "should create admin_user" do
    assert_difference('Admin::User.count') do
      post :create, admin_user: { email: @admin_user.email, image: @admin_user.image, name: @admin_user.name, password: @admin_user.password, role: @admin_user.role }
    end
  ...
  test "should update admin_user" do
    patch :update, id: @admin_user, admin_user: { email: @admin_user.email, image: @admin_user.image, name: @admin_user.name, password: @admin_user.password, role: @admin_user.role }
    assert_redirected_to admin_user_path(assigns(:admin_user))
  end
